...
router.get("/menu-import/templates", async (req, res) => {
  try {
    const zip = new JSZip();
...
router.post("/menu-import/upload", authenticateJWT, requireTenantIsolation(), requirePermissions('settings.manage'), async (req: AuthenticatedRequest, res) => {
...
router.post("/menu-import/jobs/:jobId/confirm", authenticateJWT, requireTenantIsolation(), requirePermissions('settings.manage'), async (req: AuthenticatedRequest, res) => {
  const caller = req.user;
...
router.get("/menu-import/export", authenticateJWT, requireTenantIsolation(), requirePermissions('settings.manage'), async (req: AuthenticatedRequest, res) => {
  const caller = req.user;
