...
export function Register() {
  ...
  const { user, profile, loading, signUp, signInWithGoogle } = useAuthStore();
    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12">
      <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl border border-gray-50 flex flex-col items-center text-center max-w-sm w-full mx-4">
        <div className="w-20 h-20 bg-orange-50 rounded-[2rem] flex items-center justify-center mb-8 rotate-12">
          <UserPlus size={40} className="text-orange-600 -rotate-12" />
        </div>
        <h1 className="text-4xl font-black text-gray-900 tracking-tighter mb-4">Create Account</h1>
        <p className="text-gray-500 font-medium mb-8">Join the POS platform today</p>
        ...
        <div className="w-full flex items-center gap-4 my-6">
          ...
          <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Or join with</span>
          <div className="h-[1px] bg-gray-100 flex-1"></div>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-2">
            ...
            <Link to="/login" className="text-orange-600 font-black text-xs hover:underline decoration-2 underline-offset-4">
                LOG IN HERE
            </Link>
        </div>
